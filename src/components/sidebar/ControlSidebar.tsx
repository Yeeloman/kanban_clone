...
export default function ControlSidebar() {
    ...
    return (
        <div className='w-full flex justify-start cursor-pointer'>
            <div onClick={onUse} className='w-[90%] h-[50px] hover:bg-lightpurple text-grayy 
            hover:text-purple flex flex-row dark:hover:bg-whiteprime transition ease-in delay-100 
            justify-center items-center space-x-4 rounded-r-full'>
                <CloseLogo/>
